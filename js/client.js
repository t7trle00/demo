...
{
  var url = "http://localhost/demo/index.php/api/host/listinguniqu";
  var xhttp = new XMLHttpRequest();
  xhttp.open("GET", url,true);
  var jsonData = "" ;
  var data = ""
  var cover_url = "http://localhost/demo/cover_gallery/" ;
...
{
    this.carID = carID ;
    var url = "http://localhost/demo/index.php/api/host/listinguniqu/" +"carid/" + this.carID ;
    var xhttp = new XMLHttpRequest() ;
    xhttp.open("GET",url,true) ;
    ...
    var data = "" ;
    var cover_url = "http://localhost/demo/cover_gallery/" ;
    var other_url = "http://localhost/demo/other_gallery/" ;
    xhttp.onreadystatechange = function()
    {
...
function getListing(format)
{
    ...
    var url = "http://localhost/demo/index.php/api/host/listinguniqu/userid/" + userid;
 	  var xhttp = new XMLHttpRequest();
    xhttp.open("GET", url,true);
    var jsonData = "" ;
    var cover_url = "http://localhost/demo/cover_gallery/" ;
...
{
    this.carID = carID ;
    var url = "http://localhost/demo/index.php/api/host/listing/userid/" +userid + "/carid/"+ this.carID ;
    var xhttp = new XMLHttpRequest() ;
    xhttp.open("GET",url,true) ;
...
{
    this.del_id = carID ;
    var url = "http://localhost/demo/index.php/api/host/listing/carid/" + this.del_id ;
	var xhttp = new XMLHttpRequest();
...
function AddListing()
{
    var url = "http://localhost/demo/index.php/api/host/listing";
	  var xhttp = new XMLHttpRequest();
